...
var files_length= document.getElementById('file').files.length
  ...
  //   disable_or_enable_inputs(true,edited_data)
  ...
  function showFile(){
    ...
    if(validExtensions.includes(fileType)){ 
      ...
      fileReader.onload = ()=>{
        ...
        files_length= document.getElementById('file').files.length
      }
...
$("#Document_Comment_1").val('updated');
$("#Document_Comment_2").val('updated');
dropArea.classList.remove("active");
let header_tag = `<header><a id="upload_file" style="color: cornflowerblue;">Upload</a>/Drop your files here</header>`; 
...
// function disable_or_enable_inputs(req_Val,edited_data)
// {
